...
grammar = {
   ...
   Port = V"Spc"^0*pT.parsePort(P"port"* V"Spc"^1 * C(V"Id") * V"Spc"^1 * C(V"Id")*(P"."*C(V"Id"))^-1),
   ...
   *(V"PresentationElement"+V"Port"+V"Property"+V"Link"+V"MacroCall"+V"Template"+V"Spc")^0 *C(V"End"), false),
   ...
   Link = V"Spc"^0*pT.parseLink((V"Condition" *V"Spc"^1* ((V"Property"+V"Action")-V"End")^0 *C(V"End")*V"Spc"^0), false),
   ...
   *(V"MacroPresentationElement"+V"Port"+V"Property"+V"Link"+V"Template"+V"MacroCall"+V"Spc")^0 *C(V"End"), true),
   ...
   MacroCall = V"Spc"^0*pT.parseMacroCall(C(V"Id") * V"Arguments"),
   ...
   Template = V"Spc"^0*pT.parseTemplate(V"For"*V"Spc"^1*V"MacroCall"^0*V"Spc"^0* C(V"End")),
   For = (P"for" *V"Spc"^1* C(V"Lower"^1) *V"Spc"^0* P"="* V"Spc"^0*C(V"Digit"^1)*V"Spc"^0*P","*V"Spc"^0* P"#"*C((V"Lower"+V"Digit")^1) *V"Spc"^1* P"do"),

   START = ((V"Spc"^0* Ct((V"Template"+V"Port"+V"Macro"+V"PresentationElement"+pT.parseLink(V"Link")+V"MacroCall")^0) * V"Spc"^0)* V"EOS"),
}
